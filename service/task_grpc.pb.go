...
type TaskServiceClient interface {
	TaskCreate(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*UsualResponse, error)
	TaskUpdate(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*UsualResponse, error)
	TaskShow(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TasksDetailResponse, error)
	TaskDelete(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*UsualResponse, error)
}
...
func (c *taskServiceClient) TaskCreate(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*UsualResponse, error) {
	out := new(UsualResponse)
...
func (c *taskServiceClient) TaskUpdate(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*UsualResponse, error) {
	out := new(UsualResponse)
...
func (c *taskServiceClient) TaskDelete(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*UsualResponse, error) {
	out := new(UsualResponse)
...
type TaskServiceServer interface {
	TaskCreate(context.Context, *TaskRequest) (*UsualResponse, error)
	TaskUpdate(context.Context, *TaskRequest) (*UsualResponse, error)
	TaskShow(context.Context, *TaskRequest) (*TasksDetailResponse, error)
	TaskDelete(context.Context, *TaskRequest) (*UsualResponse, error)
...
func (UnimplementedTaskServiceServer) TaskCreate(context.Context, *TaskRequest) (*UsualResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskCreate not implemented")
}
func (UnimplementedTaskServiceServer) TaskUpdate(context.Context, *TaskRequest) (*UsualResponse, error) {
...
func (UnimplementedTaskServiceServer) TaskDelete(context.Context, *TaskRequest) (*UsualResponse, error) {
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ToDoList_grpc/service/pb/task.proto",
}
